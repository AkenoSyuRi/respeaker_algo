...
```text
adjacent: 343 / (2 * 0.0452548) ≈ 3790 Hz
opposite: 343 / (2 * 0.064)     ≈ 2680 Hz
```
...
```text
4 个坐标正确
4 个 adjacent pair 长度约 0.0452548 m
2 个 opposite pair 长度约 0.064 m
